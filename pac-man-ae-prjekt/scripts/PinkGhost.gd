...
@export var ambush_distance = 192.0 
...
func update_path():
	...
	var ambush_target = pacman.global_position + (pacman_direction * ambush_distance)
	var new_path = main_node.get_path_to_pacman(global_position, ambush_target)
